...
#define USB_CFG_IOPORTNAME      A // Connected to PCINT0 (D-) and PCINT1 (D+) who, on ATTINY44A are PA0 and PA1, correspondingly
 ...
 */
#define USB_CFG_VENDOR_NAME     'm', 'o', 'o', '-', 'a', 'v', 'r'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'm', 'o', 'o', 'u', 's', 'e'
